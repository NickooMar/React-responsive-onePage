      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1">
        {navLinks.map((nav, index) => (
          ...
          <div className="sm:hidden flex flex-1 justify-end items-center">
            <img src={toggle ? close : menu} alt="Dropdown Menu" className="w-[28px] h-[28px] object-contain" onClick={() => setToggle((prev) => !prev)} /> 
            {/*No se debe cambiar el estado llamando al mismo estado setToggle(!toggle) por eso se utiliza prev ---setToggle((prev) => !prev)--- */}
